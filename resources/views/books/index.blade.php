            ...
            <div class="bg-white shadow sm:rounded-lg p-6">
                ...
                <form method="GET" action="{{ route('books.index') }}" class="mb-4 flex gap-4">
                    ...
                    <select name="sort" class="form-control">
                        ...
                        <option value="published_date" {{ $sort === 'published_date' ? 'selected' : '' }}>Published Date
                        </option>
                    </select>
                    ...
                    @foreach ($books as $book)
                        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                            <div class="card h-100 shadow-sm">
                                <img src="{{ asset('images/covers/' . $book->image) }}" alt="{{ $book->title }}"
                                    class="card-img-top"
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <a href="{{ route('books.show', $book) }}"
                                        class="btn btn-primary btn-sm mt-auto text-center">View Details</a>
                                    ...
                                    @if ($role === 'librarian' || $role === 'admin')
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            ...
                                            <form action="{{ route('books.destroy', $book) }}" method="POST"
                                                class="w-50" onsubmit="return confirm('Are you sure?');">
                                                @csrf
                                                @method('DELETE')
